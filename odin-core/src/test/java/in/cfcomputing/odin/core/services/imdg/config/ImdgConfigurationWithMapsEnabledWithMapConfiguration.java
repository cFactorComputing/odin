...
public class ImdgConfigurationWithMapsEnabledWithMapConfiguration {
    ...
    public static void setup() {
        ...
        System.setProperty("imdg.maps.enabled", "true");
        System.setProperty("imdg.maps.names", "map1,map2");
        System.setProperty("imdg.maps.map1.time-to-live-seconds", "100");
        System.setProperty("imdg.maps.map2.max-idle-seconds", "100");
    }
