...
import static in.cfcomputing.odin.core.services.search.MappingBuilder.buildMapping;
...
import static in.cfcomputing.odin.core.utils.JsonMapper.toJson;
...
public class ElasticSearchIndexer extends AbstractElasticConnector {
    ...
    public <T> boolean putMapping(Class<T> clazz, String indexName, String type, String idFieldName) {
        ...
        try {
            ...
            xContentBuilder = buildMapping(clazz, type,
                    idFieldName, null);
        } catch (Exception e) {
